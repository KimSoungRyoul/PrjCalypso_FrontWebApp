                ...
                <nav class="navbar navbar-default">
                  ...
                  >
                    <ul class="nav navbar-nav cl-effect-16">
                      <li>
                        <a href="index.html" class="active" data-hover="Home">
                          Home
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a
                          ...
                          aria-expanded="false"
                        >
                          Pages <span class="caret" />
                        </a>
                        <ul class="dropdown-menu">
                          <li>
                            <a href="icons.html" data-hover="Web Icons">
                              Web Icons
                            </a>
                          </li>
                          <li>
                            <a href="codes.html" data-hover="Short Codes">
                              Short Codes
                            </a>
                          </li>
                        </ul>
            ...
            <div className="container">
              <div className="agile_banner_info">
                <div className="agile_banner_info1">
                  ...
                  <div
                    id="typed-strings"
                    className="agileits_w3layouts_strings"
                  >
                    <p>
                      자유로운<i> 봉사활동 </i>
                    </p>
